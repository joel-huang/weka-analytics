...
public class SupportVectorMachine2 {
    ...
    private static void trainModel(WLSVM svmClass) throws Exception {
        ...
        File trainingData = new File("src/is_algo_train.arff");
    ...
    public static void main(String[] args) throws Exception {
        ...
        test.setValue((Attribute)fvWekaAttributes.elementAt(2), "Good");
        testingSet.add(test);
        ...
        if (predictedResult == 0) predictedResultString = "Good";
        else if (predictedResult == 1) predictedResultString = "Bad";
